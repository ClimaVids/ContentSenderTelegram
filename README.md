...
Current release is **dry-run**: it collects public stories, deduplicates them, scores relevance/public need/credibility, creates Persian drafts and stores state. Publication is deliberately disabled until the dry-run pipeline is stable.
